  ...
  return (
    <div className="safe-bottom fixed inset-x-0 bottom-0 z-30 px-4 pb-4">
      <button
        type="button"
        onClick={onClick}
        className="mx-auto flex min-h-12 w-full max-w-3xl items-center justify-between rounded-2xl bg-orange-600 px-4 py-3 text-white shadow-lg active:scale-[0.98] transition"
      >
